...
class DocumentVector:
    ...
    def add_sparse_vector_entry(self, term_id, term_value):
        """
        """
        self._sparse_vector[term_id] = term_value
    ...
    def vector_to_bytearray(self):
        ...
        for term_id, term_value in self._sparse_vector.items():
            ...
            sparse_vector_binary += doc_id_binary + term_id_binary + term_value_binary
        
        return (sparse_vector_binary, size_in_bytes)

    def bytearray_to_vector(self, sparse_vector_binary, document_vector_size):
        """
        ...
        format_doc_id = '<i'
        self._doc_id = struct.unpack_from(format_doc_id, sparse_vector_binary, size_in_bytes)[0]
        size_in_bytes += struct.calcsize(format_doc_id)
